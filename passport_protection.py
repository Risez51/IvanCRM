...
class PassportProtection(Storage):
    ...
    def start(self):
        ...
        for current_file in output_files:
            ...
            self.delete_folder_with_files(template_jpg_files)
        self.delete_folder_with_files(template_pdf_files)
