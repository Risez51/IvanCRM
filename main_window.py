...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.add_prepare_list_photo_push_button.setGeometry(QtCore.QRect(10, 500, 141, 23))
        ...
        self.articles_without_photo_table_widget.setGeometry(QtCore.QRect(0, 0, 1001, 491))
        ...
        self.articles_without_photo_table_widget.setColumnCount(3)
        item = QtWidgets.QTableWidgetItem()
        self.articles_without_photo_table_widget.setHorizontalHeaderItem(0, item)
        self.articles_without_photo_table_widget.setColumnWidth(0, 100)
        item = QtWidgets.QTableWidgetItem()
        self.articles_without_photo_table_widget.setHorizontalHeaderItem(1, item)
        self.articles_without_photo_table_widget.setColumnWidth(1, 700)
        item = QtWidgets.QTableWidgetItem()
        self.articles_without_photo_table_widget.setHorizontalHeaderItem(2, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.add_prepare_list_photo_push_button.setText(_translate("MainWindow", "Добавить файл"))
        item = self.articles_without_photo_table_widget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Артикул"))
        item = self.articles_without_photo_table_widget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Наименование"))
        item = self.articles_without_photo_table_widget.horizontalHeaderItem(2)
